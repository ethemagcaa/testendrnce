...
import { Header } from "@modules/admin/layout/components/header/Header";
import Navbar from "@modules/admin/layout/components/header/Navbar";
                ...
                {config.app.sidebar?.display && (
                    <>
                        ...
                        >
                            ...
                            >
                                <Svg path='/media/icons/duotune/abstract/abs015.svg' className=' svg-icon-1' />
                            </div>
                            <div className='d-flex align-items-center flex-grow-1 flex-lg-grow-0'>
                                <Link to={adminRoutes.dashboard} className='d-lg-none'>
