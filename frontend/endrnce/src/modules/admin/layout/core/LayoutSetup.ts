...
const LAYOUT_CONFIG_KEY = process.env.LAYOUT_CONFIG_KEY || "LayoutConfig";
...
class LayoutSetup {
    ...
    public static bootstrap = ((): ILayout => {
        return LayoutSetup.updatePartialConfig(LayoutSetup.config);
    })();
}
