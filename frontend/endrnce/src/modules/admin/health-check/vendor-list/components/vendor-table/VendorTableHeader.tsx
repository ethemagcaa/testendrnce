    ...
    return (
        <div className='card-header border-0 pt-6'>
            ...
            <div className='card-toolbar'>
                <Button baseColor={"primary"} className={"me-2"} onClick={() => navigate(adminRoutes.healthCheck.child.vendorForm)}>
                    <i className="bi bi-plus-square-fill"></i>
                    <FormattedMessage id="Add Vendor" />
                </Button>
                <DataTableSettings />
            </div>
        </div>
