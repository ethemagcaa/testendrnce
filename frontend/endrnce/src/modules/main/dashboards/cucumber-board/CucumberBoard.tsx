...
import CucumberHistoryCharts from "@modules/main/dashboards/cucumber-board/components/CucumberHistoryCharts";
import { Card } from "@components/card/Card";

const CucumberBoard: FC = () => {
    const intl = useIntl();
    ...
    return (
        <>
            <PageTitle breadcrumbs={usersBreadcrumbs}>
                {intl.formatMessage({ id: "Cucumber Board" })}
            </PageTitle>
            <TagsProvider>
                <CucumberStatistics/>
                <CucumberHistoryCharts />
                <DataTableProvider>
                    <TestCaseQueryResponseProvider>
